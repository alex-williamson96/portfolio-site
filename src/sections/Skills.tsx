...
const skillCards: SkillCardData[] = [
  ...
  { name: "Bedrock AgentCore", category: ["cloud", "tool"] },
  { name: "Amazon S3 Vectors", category: ["cloud", "tool"] },
  { name: "RAG", category: ["tool"] },
  { name: "MCP", category: ["tool"] },
  { name: "Strands Agents SDK", category: ["tool"] },
  { name: "Langfuse", category: ["tool"] },
  ...
  { name: "Nexus IQ", category: ["tool"] },
  { name: "Fortify", category: ["tool"] },
];
